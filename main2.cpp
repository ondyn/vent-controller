...
#define STATE_OPENING_FLAP = 2
#define STARTING_VENT = 3
...
struct RelayTask {
  ...
  RelayTask(byte relayId = 0) : id(relayId) {}
};
...
void debugPrintlnByte(const byte &msg) {
  if (DEBUG) {
    Serial.println(msg);
  }
}
...
void turnOffAllRelays() {
  ...
  debugPrintln("All RE OFF - long SW .");
}
